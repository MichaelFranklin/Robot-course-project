...
void applyCollisionObject1(moveit::planning_interface::PlanningSceneInterface & planning_scene_interface,moveit_msgs::CollisionObject & collision_object)
{
...
void applyCollisionObject2(moveit::planning_interface::PlanningSceneInterface & planning_scene_interface,moveit_msgs::CollisionObject & collision_object)
{
    // Add the object to be grasped (the suqare box) to the planning scene
    shape_msgs::SolidPrimitive primitive;
    primitive.type = primitive.BOX;
    primitive.dimensions.resize(3);
    primitive.dimensions[0] = 0.042496;
    primitive.dimensions[1] = 0.057710;
    primitive.dimensions[2] = 0.059872;
    ...
    box_pose.orientation.w = 1.0;
    box_pose.position.x = 0.647429;
    box_pose.position.y = 0.434308;
    box_pose.position.z = 1.045 - 1.21;
...
int main(int argc, char** argv)
{
    ...
    collision_object1.header.frame_id = move_group_interface_arm.getPlanningFrame();
    collision_object1.id = "blue_box1";
    applyCollisionObject1(planning_scene_interface,collision_object1);

    moveit_msgs::CollisionObject collision_object2;
    collision_object2.header.frame_id = move_group_interface_arm.getPlanningFrame();

    collision_object2.id = "blue_box2";
    applyCollisionObject2(planning_scene_interface,collision_object2);
    ...
    target_pose1.position.x = 0.647429;
    target_pose1.position.y = 0.434308;
    target_pose1.position.z = 0.2;
    ...
    aco.object.id = collision_object1.id;
