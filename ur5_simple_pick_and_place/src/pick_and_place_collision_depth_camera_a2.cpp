...
int main(int argc, char** argv)
{
    ...
    ROS_INFO_NAMED("tutorial", "Step 1 %s", success ? "" : "FAILED");
    ...
    ROS_INFO_NAMED("tutorial", "Step 2 %s", success ? "" : "FAILED");
    ...
    ROS_INFO_NAMED("tutorial", "Step 3 %s", success ? "" : "FAILED");
    ...
    ROS_INFO_NAMED("tutorial", "Step 4 %s", success ? "" : "FAILED");
    ...
    ROS_INFO_NAMED("tutorial", "Step 5 %s", success ? "" : "FAILED");
    ...
    ROS_INFO_NAMED("tutorial", "Step 6 %s", success ? "" : "FAILED");
    ...
    ROS_INFO_NAMED("tutorial", "Step 7 %s", success ? "" : "FAILED");
    ...
    ROS_INFO_NAMED("tutorial", "Step 8 %s", success ? "" : "FAILED");
    ...
    ROS_INFO_NAMED("tutorial", "Step 9 %s", success ? "" : "FAILED");
